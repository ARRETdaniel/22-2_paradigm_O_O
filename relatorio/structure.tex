...
\definecolor{ocre}{RGB}{0,100,0} % Define the orange color used for highlighting throughout the book
\definecolor{azulao}{RGB}{0,100,0} % Define the orange color used for highlighting throughout the book
